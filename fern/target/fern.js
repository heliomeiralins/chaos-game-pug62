// Transcrypt'ed from Python, 2019-10-30 21:09:42
...
export var nextPoint = function () {
	...
	var r = random (1);
	if (r < 0.01) {
		var __left0__ = tuple ([0, 0.16 * y]);
		x = __left0__ [0];
		y = __left0__ [1];
	}
	else if (r < 0.86) {
		var __left0__ = tuple ([0.85 * x + 0.04 * y, (-(0.04) * x + 0.85 * y) + 1.6]);
		x = __left0__ [0];
		y = __left0__ [1];
	}
	else if (r < 0.93) {
		var __left0__ = tuple ([0.2 * x - 0.26 * y, (0.23 * x + 0.22 * y) + 1.6]);
		x = __left0__ [0];
		y = __left0__ [1];
	}
	else {
		var __left0__ = tuple ([-(0.15) * x + 0.28 * y, (0.26 * x + 0.24 * y) + 0.44]);
		x = __left0__ [0];
		y = __left0__ [1];
	}
};
