// Transcrypt'ed from Python, 2019-10-30 20:33:26
...
var __name__ = 'sierpinski_thirdway';
export var POINTS = list ([tuple ([400, 100]), tuple ([100, 600]), tuple ([700, 600])]);
export var p = POINTS [0];
export var last = p;
export var thirdway = function (p1, p2) {
	if (arguments.length) {
	...
	return tuple ([(2 * p1 [0] + p2 [0]) / 3, (2 * p1 [1] + p2 [1]) / 3]);
};
...
//# sourceMappingURL=sierpinski_thirdway.map